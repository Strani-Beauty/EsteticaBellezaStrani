-- =============================================================================
-- Migración temporal de diagnóstico (se elimina en la corrección).
-- Lista las policies reales sobre profiles y el rol que ejecuta el RPC.
-- =============================================================================
CREATE OR REPLACE FUNCTION public._diag_profiles()
RETURNS TABLE (
    policy_name   TEXT,
    cmd           TEXT,
    roles         TEXT,
